<template>
  <div class="bg-zinc-800 text-gray-200 px-2 h-screen">
    <div class="flex flex-col place-items-center pt-4 pb-8 font-montserrat">
      ...
      <h3 class="text-center font-light">Astronomy and engineering teacher turned front end developer</h3>
      <p class="text-center py-4 font-light">After teaching for the past 7 years and completing a full-stack bootcamp, I have been working as a freelance developer with several clients in non-profit, construction, and retail fields</p>
    </div>
    <div class="flex flex-col place-items-center font-montserrat font-light gap-4 pb-4">
